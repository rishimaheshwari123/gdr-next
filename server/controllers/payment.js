    ...
    const expectedSignature = crypto
      ...
      if (expectedSignature === razorpay_signature) {
        try {
          ...
          await plotBook(plotId, name, email, phone, razorpay_order_id, razorpay_payment_id  );
...
const plotBook = async (plotId, name, email, phone, razorpay_order_id, razorpay_payment_id) => {
  try {
    ...
    plot.isBooked = true;
    plot.bookedInfo = { plotId, name, email, phone, razorpay_order_id, razorpay_payment_id ,date: Date.now() };
    await plot.save();
