...
import JobList from "@/components/common/CareerData";
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
              <div className="grid gap-6 lg:gap-12">
                <div className="flex gap-6 items-center">
                  ...
                  <p className="text-xl">Agriculture Farm Land</p>
                </div>
                <div className="flex gap-6 items-center">
                  <svg
                    width="70"
                  ...
                  <p className="text-xl">Farm Land</p>
                </div>
              </div>
              <div className="grid gap-6 lg:gap-12">
                <div className="flex gap-6 items-center">
